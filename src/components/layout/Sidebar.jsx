...
const Sidebar = forwardRef(function ({ hideSidebar }, ref) {
	const { sidebarView, showSidebar, setShowSidebar } = useContext(UiContext);
	...
	return (
		<div
			className={`${styles.overlay} ${
				showSidebar ? styles.overlayShow : null
			}`}
			ref={ref}
		>
			<aside
				className={`${styles.sidebar} ${
					showSidebar ? styles.sidebarShow : null
				}`}
			>
				<SidebarChannels show={sidebarView === 'all'} />
				<SidebarChannel show={sidebarView === 'info'} />
			</aside>
			<button
